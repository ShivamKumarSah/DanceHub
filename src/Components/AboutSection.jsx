...
const Shape1 = () => (
    <svg
        className="absolute left-0 top-0 text-red-300 -z-10"
        width="765"
        height="352"
        viewBox="0 0 765 352"
        fill="none"
...
const Shape2 = () => (
    <svg
        className="absolute top-0 bottom-0 left-1/4 lg:left-[45%] text-red-300"
        width="765"
        height="616"
        viewBox="0 0 765 616"
        fill="none"
...
const AboutSection = () => {
    return (
        <section className="ezy__header23 light py-14 md:py-24 bg-white dark:bg-[#0b1727] text-zinc-900  relative overflow-hidden z-10">
            <Shape1 />
                ...
                <div className="grid grid-cols-12 gap-y-6 lg:gap-x-6">
                    <div className="col-span-12 lg:col-span-6 xl:pr-12 text-center lg:text-start">
                        <div className="flex flex-col justify-center h-full">
                            <p className="text-start style-font">about The Dance School</p>
                            <h2 className="text-start text-3xl md:text-[50px] md:leading-[85px] capitalize font-bold mb-4">
                                We provide service since in 2008
                            </h2>
                            <p className="text-start text-[18px] leading-normal opacity-80">
                                Dramatically morph reliable experiences without strategic methodologies. Quickly create frictionless strategic theme areas. Completely maximize economically sound e-markets after user-centric deliverables. Proactively create intuitive ROI and.
                                <br />
                                <br />
                                Compellingly expedite end-to-end sources without visionary process improvements. Compellingly exploit maintainable supply chains.
                            </p>
                            <div className="text-start">
                                <a
                                    href="#!"
                                    className=" bg-red-600 rounded py-3 px-8 hover:bg-opacity-90 duration-300 text-white text-xl inline-flex mt-6 md:mt-10"
                                >
                                    Learn More
                                </a>
                            </div>
                    ...
                    <div className="col-span-12 lg:col-span-6 flex items-center justify-center relative pb-6 ">
                        ...
                        <img
                            src="https://themeholy.com/wordpress/test/wp-content/uploads/2023/09/about_1-1.jpg"
                            alt=""
                            className="rounded-lg max-w-full h-auto relative mt-5"
                        />
                    </div>
                </div>
            </div>
